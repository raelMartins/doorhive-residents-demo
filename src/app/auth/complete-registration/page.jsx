...
import { fetchRegistrationDetails } from '@/api/auth';
...
export default async function SignUpPage({ params, searchParams }) {
  ...
  try {
    // residence = await fetchResidence(searchParams.residence_id);
    // residents = await getResidents(searchParams.residence_id);
    // resident = residents?.find((el) => el.email === searchParams.email);
            ...
            >
              ...
              >
                ...
                <Text
                  ...
                  verticalAlign={`middle`}
                >
                  Welcome to the Oakridge Community! To complete your
              ...
              <Box flex={`1`} maxW={{ base: `100%`, lg: `500px` }}>
                <AuthFlow details={details} token={searchParams.token} />
              </Box>
            </Flex>
          </>
        )}
